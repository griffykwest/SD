...
A_Bank = params.get('A_bank')  #0 is fully out 1 is fully in
B_Bank = params.get('A_bank')  #0 is fully out 1 is fully in
C_Bank = params.get('A_bank')  #0 is fully out 1 is fully in
Shut_Down_Bank = params.get('shutdown_bank')  #0 is fully out 1 is fully in
Boron_PPM = params.get('boron_ppm')
"""
