...
f = universes['BP Bank Shut Down Assembly']
...
plot_1 = openmc.Plot()
plot_1.filename = 'above core plot'
...
plot_3 = openmc.Plot()
plot_3.filename = 'yz plot'
plot_3.width = [r_rpvouter, 536] #[r_rpvouter, r_rpvouter]
plot_3.pixels = [2000, 6000]
plot_3.origin = [0,r_rpvouter/2,88]#[r_rpvouter/2,r_rpvouter/2,-99]
plot_3.basis = 'yz'
