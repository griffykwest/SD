...
cells['lower plenum'].region = -surfaces['z-max'] & +surfaces['z-top active'] & -surfaces['inner core barrel'] & +surfaces['qc x'] & +surfaces['qc y']
cells['upper plenum'].region = +surfaces['z-min'] & -surfaces['z-bottom active'] & -surfaces['inner core barrel'] & +surfaces['qc x'] & +surfaces['qc y']
